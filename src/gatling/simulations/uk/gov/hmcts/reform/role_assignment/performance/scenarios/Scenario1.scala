...
object Scenario1 {
  ...
  val Scenario1 = scenario("Scenario1")
    ...
    .exec(http(requestName="AM_050_GetRoles")
      .get("/am/role-assignments/roles")
      .headers(Environment.headers_1)
      .check(status.is(200)))
    .pause(2)

    .exec(http(requestName="AM_070_GetRoleAssignmentsActor")
    ...
    .exec(http(requestName="AM_080_DeleteRoleAssignments")
      .delete("/am/role-assignments/${assignmentId}&${assignmentId2}&${assignmentId3}")
      .headers(Environment.headers_1)
